...
const cspBase =
  "default-src 'self'; img-src 'self' data: blob: http://103.31.204.110:1608 https://s3.jahris.id; style-src 'self' 'unsafe-inline'; font-src 'self' data:; connect-src 'self' http://103.31.204.110:1608 https://s3.jahris.id; object-src 'none'; frame-ancestors 'none'; base-uri 'self'; form-action 'self'";
