...
interface RenderActionsProps {
  row: AccountCategoryDto;
  checkRole: (module: string, action: string) => boolean;
  onView: (row: AccountCategoryDto) => void;
...
export const columnFormats: DefaultColumnFormat<AccountCategoryDto>[] = [
  {
    key: "code",
    title: "Kode",
      ...
      {filters.show && (
        <div className="mb-6 rounded-lg border bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700/50">
          <div className="mb-4 flex items-center justify-between">
            <h3 className="font-semibold text-slate-900 dark:text-white">Filter Data Kategori Akun</h3>
            {filters.activeCount > 0 && (
              <button
