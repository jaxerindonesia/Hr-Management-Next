...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { id: "payroll", name: "Payroll", icon: () => <span className="text-lg font-bold">Rp</span>, path: "/payroll" },
    { id: "performance", name: "Penilaian Kinerja", icon: TrendingUp, path: "/performance" },
  ];
